  ...
  return (
    <SafeAreaView style={[styles.root, { backgroundColor: colors.background }]} edges={["top"]}>
      ...
      >
        ...
        <Text style={[styles.subtitle, { color: colors.textSecondary }]}>Choose which alerts you want to receive from FixGlobal.</Text>
        ...
        >
          <Text style={[styles.saveButtonText, { color: colors.panel }]}>Save Preferences</Text>
        </Pressable>
      </ScrollView>
